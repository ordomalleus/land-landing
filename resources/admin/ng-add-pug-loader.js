 ...
 */
const fs = require('fs');
// Путь до конфига вебпака ангуляра
const commonCliConfig = 'node_modules/@angular-devkit/build-angular/src/angular-cli-files/models/webpack-configs/common.js';
// Правила которые надо добавить, отдельно для pug и отдельно для html(чтоб старые шаблоны работали)
const pugRules = '{ test: /.pug$/, use: [ { loader: "apply-loader" }, { loader: "pug-loader" } ] }, { test: /.html$/, use: [ { loader: "raw-loader" } ] },';
