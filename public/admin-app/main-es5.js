...
var DialogLandEditComponent = /** @class */ (function () {
    function DialogLandEditComponent(data, matDialogRef, httpClient) {
        this.data = data;
    ...
    DialogLandEditComponent.prototype.ngOnInit = function () {
        var _this = this;
        // Получим токен текущей сессии
        this.httpClient.get('/admin/csrf').subscribe(function (data) {
            _this.crsf = data;
        });
        this.getOneLand();
        // Прочекаем контролы
     ...
     * Получим землю
     */
    DialogLandEditComponent.prototype.getOneLand = function () {
        var _this = this;
        // Получим текущую землю по id
        this.httpClient.get("/admin/land/get-one/" + this.data.id).subscribe(function (data) {
            _this.land = data;
        });
    };
    /**
     ...
     * @param id
     */
    DialogLandEditComponent.prototype.deleteImage = function (id) {
        var _this = this;
        // Добавим загаловок
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]();
        headers = headers.append('XSRF-TOKEN', this.crsf);
        // Делаем запрос
        this.httpClient.delete("/admin/land/delete-image/" + id, { headers: headers }).subscribe(function (data) {
            // Получим землю
            _this.getOneLand();
        });
    };
    DialogLandEditComponent.prototype.confirm = function () {
        var result = this.form.getRawValue();
        var newResult = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, result, { img_sliders: result.img_sliders ? result.img_sliders.files : [], img_name: result.img_name ? result.img_name.files ? result.img_name.files[0] : '' : '' });
    ...
    DialogLandEditComponent.ctorParameters = function () { return [
    ...
    return DialogLandEditComponent;
}());
...
var LandAddComponent = /** @class */ (function () {
    function LandAddComponent(httpClient, snackBar) {
        this.httpClient = httpClient;
    ...
    LandAddComponent.prototype.ngOnInit = function () {
        var _this = this;
        // Получим токен текущей сессии
        this.httpClient.get('/admin/csrf').subscribe(function (data) {
            _this.crsf = data;
    ...
    LandAddComponent.prototype.confirm = function () {
        var _this = this;
        this.apiSend = true;
        var result = this.form.getRawValue();
        var newResult = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, result, { img_sliders: result.img_sliders ? result.img_sliders.files : [], img_name: result.img_name ? result.img_name.files[0] : '' });
        var formData = new FormData();
        Object.keys(newResult).forEach(function (key) {
            // Если поле c картинками то разабьем их иначе, создадим массив и добавив в него только тело файлов
            if (key === 'img_sliders') {
        ...
        headers = headers.append('XSRF-TOKEN', this.crsf);
        // Делаем запрос
        this.httpClient.post('/admin/land/add', formData, { headers: headers }).subscribe(function (data) {
            _this.apiSend = false;
            _this.snackBar.open('Новая земля добавлена', '', { duration: 5000 });
        }, function () {
            _this.snackBar.open('Ошибка', '', { duration: 5000 });
        });
    };
    LandAddComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
...
var LandEditComponent = /** @class */ (function () {
    function LandEditComponent(httpClient, matSnackBar, matDialog) {
        this.httpClient = httpClient;
    ...
    LandEditComponent.prototype.ngOnInit = function () {
        var _this = this;
        // Получим токен текущей сессии
        this.httpClient.get('/admin/csrf').subscribe(function (data) {
            _this.crsf = data;
    ...
    // Получим все земли
    LandEditComponent.prototype.getLands = function () {
        var _this = this;
        // Получим все земли
        this.httpClient.get('/admin/land/get-all').subscribe(function (data) {
            _this.lands = data;
        });
    };
    // Удалить землю
    LandEditComponent.prototype.deleteLand = function (id) {
        var _this = this;
        this.matDialog
            .open(_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_6__["ConfirmComponent"], { data: { quest: 'Вы уверены, что хотите удалить?' } })
            .afterClosed()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (confirmed) {
            if (confirmed) {
                // Добавим загаловок
                var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
                headers = headers.append('XSRF-TOKEN', _this.crsf);
                // Делаем запрос
                _this.httpClient.delete("/admin/land/delete/" + id, { headers: headers }).subscribe(function (data) {
                    _this.matSnackBar.open('Земля удалена', '', { duration: 5000 });
                    // Получим землю
                    _this.getLands();
                }, function () {
                    _this.matSnackBar.open('Ошибка', '', { duration: 5000 });
                });
            }
        })).subscribe();
    };
    // Модалка с редактированием
    LandEditComponent.prototype.editLand = function (id) {
        var _this = this;
        this.matDialog
            .open(_dialog_land_edit_dialog_land_edit_component__WEBPACK_IMPORTED_MODULE_7__["DialogLandEditComponent"], { data: { id: id } })
            .afterClosed()
            ...
            if (data && data.confirmed) {
                ...
                headers = headers.append('XSRF-TOKEN', _this.crsf);
                // Делаем запрос
                _this.httpClient.post("/admin/land/edit/" + id, data.formData, { headers: headers }).subscribe(function (data) {
                    _this.matSnackBar.open('Земля изменена', '', { duration: 5000 });
                    // Получим землю
                    _this.getLands();
                }, function () {
                    _this.matSnackBar.open('Ошибка', '', { duration: 5000 });
    ...
    LandEditComponent.ctorParameters = function () { return [
...
var SettingsEditComponent = /** @class */ (function () {
    function SettingsEditComponent(httpClient, snackBar) {
        this.httpClient = httpClient;
        this.snackBar = snackBar;
        // Форма
        this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
    ...
    SettingsEditComponent.prototype.ngOnInit = function () {
        var _this = this;
        // Получим токен текущей сессии
        this.httpClient.get('/admin/csrf').subscribe(function (data) {
            _this.crsf = data;
     ...
     */
    SettingsEditComponent.prototype.getGlobalSettings = function () {
        var _this = this;
        this.httpClient.get('/admin/settings/get-all').subscribe(function (data) {
            _this.globalSettings = data;
            _this.color = data.color_block;
        });
    };
    SettingsEditComponent.prototype.serColor = function (color) {
        this.color = color;
        this.form.get('color_block').patchValue(color);
    };
    SettingsEditComponent.prototype.confirm = function () {
        var _this = this;
        var result = this.form.getRawValue();
        var newResult = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, result, { global_image: result.global_image ? result.global_image.files ? result.global_image.files[0] : '' : '' });
        var formData = new FormData();
        Object.keys(newResult).forEach(function (key) {
            formData.append(key, newResult[key]);
        });
        ...
        headers = headers.append('XSRF-TOKEN', this.crsf);
        // Делаем запрос
        this.httpClient.post('/admin/settings/edit', formData, { headers: headers }).subscribe(function (data) {
            _this.snackBar.open('Настройки изменены', '', { duration: 5000 });
        }, function () {
            _this.snackBar.open('Ошибка', '', { duration: 5000 });
        });
    };
    SettingsEditComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatSnackBar"] }
    ]; };
 ...
 */
var ConnectFormMethods = /** @class */ (function () {
    function ConnectFormMethods() {
    }
    /**
     ...
     * @param val
     */
    ConnectFormMethods.pathValue = function (formGroup, val) {
        ...
        Object.keys(formGroup.controls).forEach(function (controlName) {
            ...
            var valControl = val[controlName];
            // Если приходит массив, то создаем новый (копируем)
            if (Array.isArray(valControl)) {
                valControl = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](valControl);
            }
     ...
     * @param formGroup
     */
    ConnectFormMethods.markFormGroupTouched = function (formGroup) {
     ...
     * @param formGroup
     */
    ConnectFormMethods.nullControl = function (formGroup) {
        Object.values(formGroup.controls).forEach(function (control) {
            // Рекурсия на вложеные FormGroup
            if (control instanceof _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]) {
                ConnectFormMethods.nullControl(control);
...
var ConnectFormDirective = /** @class */ (function () {
    function ConnectFormDirective(formGroupDirective, changeDetectorRef) {
    ...
    ConnectFormDirective.ctorParameters = function () { return [
